...
if authentication_status:
    ...
    if tasks_selected_date:
        ...
        if st.button("Delete Task"):
            ...
            st.warning(f"Task with ID {task_id_to_delete} deleted! Please refresh to see updated tasks.")
...
# Footer aesthetics
st.markdown("---")
st.write("Made with ❤️ using Streamlit to keep track of your deadlines.")
